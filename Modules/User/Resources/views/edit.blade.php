        ...
        <div class="container-fluid">
            <div class="nk-content-inner">
                <div class="nk-content-body">
                    ...
                    <form action="{{ route('users.update', $user->id) }}" class="form-contact needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                        @csrf
                        @method('patch')
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="datetime-local" id="timer" name="timer" value="{{ old('timer') ?? $user->timer}}"
                            ...
                            <div class="col-md-4 mt-5">
                                <div class="sp-plan-opt clone-file ml-4">
                                    <div class="custom-control custom-switch">
                                        ...
                                        <label class="custom-control-label text-soft" for="status">Status</label>
                                        @error ('status')
