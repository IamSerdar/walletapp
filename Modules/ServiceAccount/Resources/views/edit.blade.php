        ...
        <div class="container-fluid">
            <div class="nk-content-inner">
                <div class="nk-content-body">
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">{{ $serviceAccount->user->username }}</h3>
                    ...
                    <form action="{{ route('serviceAccounts.update', $serviceAccount->id) }}" class="form-contact needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                        @csrf
                        @method('patch')
                        ...
                        <div class="row g-4">
                                  ...
                                  <div class="form-control-wrap">
                                    <select class="form-select @error('user_id') is-invalid @enderror" id="user_id" name="user_id" data-ui="lg" data-search="on">
                                      ...
                                      @foreach ($users as $user)
                                        <option value="{{ $user->id }}" {{ $user->id == $serviceAccount->user->id ? 'selected' : ''}}>{{ $user->username }}</option>
                                      @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="text" id="address" name="address" value="{{ old('address') ?? $serviceAccount->address }}"
