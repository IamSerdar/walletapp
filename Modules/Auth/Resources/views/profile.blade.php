                ...
                <div class="nk-content-body">
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">@lang('main.my_profile')</h3>
                                ...
                                <div class="nk-data data-list">
                                    ...
                                    <div class="data-item" data-toggle="modal" data-target="#profile-edit">
                                        <div class="data-col">
                                            ...
                                            <span class="data-value">+993 {{ $user->phone }}</span>
                                        </div>
                                        <div class="data-col data-col-end">
                                            <span class="data-more">
                                                <em class="icon ni ni-forward-ios"></em>
                                    ...
                                    <div class="data-item" data-toggle="modal" data-target="#profile-edit">
                                        <div class="data-col">
                                            ...
                                            <span class="data-value text-soft">{{ optional($user->birthday)->format('Y-m-d') }}</span>
                                        </div>
                                        <div class="data-col data-col-end">
                                            <span class="data-more">
                                                <em class="icon ni ni-forward-ios"></em>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password_confirmation" id="password_confirmation"
                                        ...
                                        placeholder="@lang('main.repeat_password_confirmation')">
